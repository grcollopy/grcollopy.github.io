<template>
  <div class="container">
    ...
    <div class="section details">
      ...
      <p>Instead of flowers we would like to suggest people make a donation to:</p>
      ...
      <a class="button" target="_blank" rel=”noopener” href="https://www.justgiving.com/fundraising/georgecollopymemorial/">Donate to The Stroke Association</a>
    </div>
  </div>
</template>
